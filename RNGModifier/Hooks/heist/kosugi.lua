...
MenuHelper:AddMultipleChoice({
	...
	value = RNGModifier:SafeGetData(_Curret_Heist, "_money_container"),
	menu_id = "RNGModifier_kosugi_Options_Menu"
})

MenuCallbackHandler.RNGModifier_kosugi_crate_loc_1 = function(self, item)
	RNGModifier:SafeSetData(item:value(), _Curret_Heist, "_crate_loc_1")
	RNGModifier:Save()
end
MenuHelper:AddMultipleChoice({
	...
	value = RNGModifier:SafeGetData(_Curret_Heist, "_crate_loc_1"),
	menu_id = "RNGModifier_kosugi_Options_Menu"
})

MenuCallbackHandler.RNGModifier_kosugi_crate_loc_2 = function(self, item)
	RNGModifier:SafeSetData(item:value(), _Curret_Heist, "_crate_loc_2")
	RNGModifier:Save()
end
MenuHelper:AddMultipleChoice({
	...
	value = RNGModifier:SafeGetData(_Curret_Heist, "_crate_loc_2"),
	menu_id = "RNGModifier_kosugi_Options_Menu"
})


MenuCallbackHandler.RNGModifier_kosugi_crate_loc_3 = function(self, item)
	RNGModifier:SafeSetData(item:value(), _Curret_Heist, "_crate_loc_3")
	RNGModifier:Save()
end
MenuHelper:AddMultipleChoice({
	...
	value = RNGModifier:SafeGetData(_Curret_Heist, "_crate_loc_3"),
	menu_id = "RNGModifier_kosugi_Options_Menu"
})


MenuCallbackHandler.RNGModifier_kosugi_crate_loc_4 = function(self, item)
	RNGModifier:SafeSetData(item:value(), _Curret_Heist, "_crate_loc_4")
	RNGModifier:Save()
end
MenuHelper:AddMultipleChoice({
	...
	value = RNGModifier:SafeGetData(_Curret_Heist, "_crate_loc_4"),
	menu_id = "RNGModifier_kosugi_Options_Menu"
})


MenuCallbackHandler.RNGModifier_kosugi_crate_loc_5 = function(self, item)
	RNGModifier:SafeSetData(item:value(), _Curret_Heist, "_crate_loc_5")
	RNGModifier:Save()
end
MenuHelper:AddMultipleChoice({
	...
	value = RNGModifier:SafeGetData(_Curret_Heist, "_crate_loc_5"),
	menu_id = "RNGModifier_kosugi_Options_Menu"
})

MenuCallbackHandler.RNGModifier_kosugi_crate_loc_6 = function(self, item)
	RNGModifier:SafeSetData(item:value(), _Curret_Heist, "_crate_loc_6")
	RNGModifier:Save()
end
MenuHelper:AddMultipleChoice({
	...
	value = RNGModifier:SafeGetData(_Curret_Heist, "_crate_loc_6"),
	menu_id = "RNGModifier_kosugi_Options_Menu"
})
